...
class AdminAnnouncementTable extends React.Component{
	constructor(props){
		super(props);
		this.state={
			parentchecked:false,
	...
	deleteRecord = (e) =>{
		...
		try{
			fetch(Admin.delete_announcement_details.url+`${this.state.setSingleDeleteId}?_format=json`,{
	                method:Admin.delete_announcement_details.method,
					headers: {
