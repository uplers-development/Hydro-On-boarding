   			...
   			return(
					<>		
							...
							<div className="btn-block">
									<button className="common-btn-blue" onClick={((e)=>{e.preventDefault();this.props.checktheviewcalled(true,false,true,JSON.parse(localStorage.getItem("user-type")).uid)})}><span>ADD NEW</span></button>
							</div>
				   </>
   				)
  		 }
