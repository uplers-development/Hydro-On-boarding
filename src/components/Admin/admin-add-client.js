...
import Adminaddclient from './Admincomponents/Adminaddclient'
import Adminaddproduct from './Admincomponents/Adminaddproduct'
import Adminaddcontract from './Admincomponents/Adminaddcontract'
import {ValidationMsg} from'../constants/validationmsg';

let object={};
let productList=[];
class Addadminclient extends React.Component {
	constructor(props) {
		super(props);
		this.state={
			menulisting:[],
      ...
      <div>
         <section className="main-wrapper">
            <div className="d-flex flex-wrap main-block">
               <Adminnavbar repmenulisting={this.state.menulisting}/>
               <div className="d-flex flex-wrap right-content-part">
                  <div className="top-heading">
                    <Adminheader historyPush={this.props} menulisting={this.state.menulisting} repuserinfo={this.state.repinfo} getAdminuid={this.getadmindetail}/>
                  </div>
                  ...
                  <div className="bottom-content-block with-filter">
                     <div className="d-flex flex-wrap clients-add-main">
                        <div className={this.state.sectionCalldiversion}>
                           {/*<Repaddclient/>*/}
                           {this.state.fromProductSec && <Adminaddproduct callforproduct={this.state.fromProductSec} senduid={this.state.getClientuid} getProductList={this.getProductsforContract} historyPush={this.props}/>}
                    		   {this.state.fromContractSec && <Adminaddcontract checkcontractfrom={this.state.fromContractSec} senduid={this.state.getClientuid} productDataList={this.state.getProductList} historyPush={this.props}/>}
                        </div>
                     </div>
                  </div>
                  : 
                  <div className="bottom-content-block with-filter">
                     <div className="d-flex flex-wrap clients-add-main">
                        ...
                        <div className="clients-add">
                           <Adminaddclient getClienttoadd={this.get_client_to_be_add} firstname={
                           ...
                           <Adminaddproduct getproducttoadd={this.get_product_to_add} getProductList={this.getProductsforContract}/>
                           {this.state.contractProductAdmitted &&  <Adminaddcontract getcontracttoadd={this.get_contract_to_be_add} productDataList={this.state.getProductListforcontract} />}
                        </div>
