...
//export const base_url=process.env.NODE_ENV!=='production' && window.location.origin!=="http://hydro-on-boarding.dev.project-progress.net" ? 'http://hydrochannelonboardijwaxudrtd.devcloud.acquia-sites.com' : 'http://hydro.staging.project-progress.net';
//export const site_url=process.env.NODE_ENV!=='production' && window.location.origin!=="http://hydro-on-boarding.dev.project-progress.net" ? 'http://hydrochannelonboardijwaxudrtd.devcloud.acquia-sites.com/' :'http://hydro.staging.project-progress.net/';
